...
const (
	Demo_SayDemo_FullMethodName = "/helloworld.v1.Demo/SayDemo"
)
...
type DemoClient interface {
	SayDemo(ctx context.Context, in *Trades, opts ...grpc.CallOption) (*Trades, error)
}
...
func (c *demoClient) SayDemo(ctx context.Context, in *Trades, opts ...grpc.CallOption) (*Trades, error) {
	out := new(Trades)
	err := c.cc.Invoke(ctx, Demo_SayDemo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDemoServer) SayDemo(context.Context, *Trades) (*Trades, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SayDemo not implemented")
}
...
func _Demo_SayDemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Trades)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).SayDemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Demo_SayDemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).SayDemo(ctx, req.(*Trades))
	}
